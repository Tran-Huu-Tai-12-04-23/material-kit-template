...
export const createNewTeam = async (team) => handleErrorApi(async () => {
  const res = await rootApi.post(endpoints.create_team, team);
  toast.success(res.message);
  return res.data;
});

export const getLstUserToInviteTeam = async (data) => handleErrorApi(async () => {
...
export const paginationTeamOfUser = async (page) => handleErrorApi(async () => {
